...
//     version 1.11.2
//     from Assets/Scripts/Menu/PauseMenu.inputactions
//
...
public partial class @PauseMenu: IInputActionCollection2, IDisposable
{
    ...
    ~@PauseMenu()
    {
        UnityEngine.Debug.Assert(!m_Menu.enabled, "This will cause a leak and performance issues, PauseMenu.Menu.Disable() has not been called.");
    }
