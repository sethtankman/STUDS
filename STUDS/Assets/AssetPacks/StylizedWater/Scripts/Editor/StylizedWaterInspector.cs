...
namespace StylizedWaterShader
{
    ...
    public class StylizedWaterInspector : Editor
    {
        ...
        void DoInfo()
        {
            ...
            {
                if (stylizedWater.currentCam.cameraType == CameraType.Game && stylizedWater.currentCam.gameObject.hideFlags == HideFlags.None && stylizedWater.currentCam.depthTextureMode == DepthTextureMode.None && stylizedWater.currentCam.actualRenderingPath == RenderingPath.Forward && enableDepthTex.boolValue)
                {
                    ...
                    using (new EditorGUILayout.HorizontalScope())
                    {
                        ...
                        if (GUILayout.Button("Fix", GUILayout.Width(60)))
                        {
                            ...
                            EditorUtility.SetDirty(stylizedWater.currentCam);
