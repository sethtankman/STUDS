...
public class AkMIDIPost : AkMIDIEvent {
  ...
  internal AkMIDIPost(global::System.IntPtr cPtr, bool cMemoryOwn) : base(AkUnitySoundEnginePINVOKE.CSharp_AkMIDIPost_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = cPtr;
  }
  ...
  internal override void setCPtr(global::System.IntPtr cPtr) {
    base.setCPtr(AkUnitySoundEnginePINVOKE.CSharp_AkMIDIPost_SWIGUpcast(cPtr));
    swigCPtr = cPtr;
  }
  ...
  public uint PostOnEvent(uint in_eventID, ulong in_gameObjectID, uint in_uNumPosts) {
		uint ret = AkUnitySoundEnginePINVOKE.CSharp_AkMIDIPost_PostOnEvent__SWIG_0(swigCPtr, in_eventID, in_gameObjectID, in_uNumPosts);
  ...
  public uint PostOnEvent(uint in_eventID, ulong in_gameObjectID, uint in_uNumPosts, bool in_bAbsoluteOffsets) {
		uint ret = AkUnitySoundEnginePINVOKE.CSharp_AkMIDIPost_PostOnEvent__SWIG_1(swigCPtr, in_eventID, in_gameObjectID, in_uNumPosts, in_bAbsoluteOffsets);
		AkCallbackManager.SetLastAddedPlayingID(ret);
		return ret;
	}
  ...
  public uint PostOnEvent(uint in_eventID, ulong in_gameObjectID, uint in_uNumPosts, bool in_bAbsoluteOffsets, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie) {
    ...
    {
		uint ret = AkUnitySoundEnginePINVOKE.CSharp_AkMIDIPost_PostOnEvent__SWIG_2(swigCPtr, in_eventID, in_gameObjectID, in_uNumPosts, in_bAbsoluteOffsets, in_uFlags, in_uFlags != 0 ? (global::System.IntPtr)1 : global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(ret);
		return ret;
	}
  }
